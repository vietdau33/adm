        ...
        <form action="{{ route('auth.register.post') }}" method="POST" onsubmit="return false;">
            ...
            @if(request()->get('ref'))
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="reflink" autofocus id="reflink" value="{{ request()->get('ref') }}" readonly>
                </div>
            @endif
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="fullname" id="enter_fullname" required autocomplete="off">
            </div>
            <div class="form-group">
                <label for="enter_phone">{{ __('auth.enter_phone') }}</label>
                <input type="text" class="form-control number-only" name="phone" id="enter_phone" required autocomplete="off">
            </div>
            <div class="form-group">
                <label for="enter_birthday">Date of Birthday</label>
                <input type="text" class="form-control datepicker" name="birthday" id="enter_birthday" required autocomplete="off">
            </div>
