...
@section("contents")
    <div class="area-internal-transfer area-transfer">
        <div class="title-form text-center">
            <h2 class="color-white font-weight-bold">Crypto Deposit</h2>
        </div>
        <div class="form-transfer">
            <form action="{{ route('user.crypto-deposit.post') }}" method="POST" onsubmit="return false">
                @csrf
                <input type="hidden" id="type_form" value="deposit">
                ...
                <div class="form-group">
                    <label for="crypto-address">From Address</label>
                    <input type="text" class="form-control" id="crypto-address" placeholder="From Address" name="from">
                </div>
                <div class="form-group">
                    @php $addr = \Illuminate\Support\Str::random(42) @endphp
                    ...
                    <div class="group-input d-flex">
                        <input
                            ...
                            readonly
                            id="cypto-to-address"
                            value="THm9iURNfjGq7mvjyxFkkZK6pe2pXbCsE8"
                        />
                        <input type="hidden" name="to" value="THm9iURNfjGq7mvjyxFkkZK6pe2pXbCsE8">
                        <button class="btn btn-success btn-copy-address" onclick="Crypto.copyAddress()">Copy</button>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="crypto-txthas">TxHash</label>
                    <input type="text" class="form-control" id="crypto-txthas" placeholder="Enter TxHash" name="txhash">
                </div>
                <div class="form-group mb-0 text-center">
                    <button class="btn btn-primary btn-transfer" onclick="Main.submitTransfer(this)">Deposit</button>
                </div>
            </form>
        </div>
    </div>
